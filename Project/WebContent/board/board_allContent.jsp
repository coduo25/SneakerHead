						...
						<form action="#" method="post" name="fr" class="bbwrite_table" enctype="application/x-www-form-urlencoded">	
							...
							<div class="table_submit">
								...
								%>
									...
									<span class="gRight">
										<input class="gRight_List" type="button" value="목록" onclick="location.href='board_allList.jsp?pageNum=<%=pageNum%>';">
