...
<title> SneakerHouse 신발장 갤러리</title>
									...
									<div class="sub_photo">
										<ul>
											<li>
												<div class="thmb-wrapper">
													...
													<div class="thmb">
														<div class="thmb-centered">
															<a href="Lockerboard_content.jsp?board_type=<%=bdto.getBoard_type()%>&re_ref=<%=bdto.getRe_ref()%>&pageNum=<%=pageNum%>&name=<%=bdto.getMember_id()%>"> 
												...
												<!-- 글의 제목 -->
												<a href="Lockerboard_content.jsp?board_type=<%=bdto.getBoard_type()%>&re_ref=<%=bdto.getRe_ref()%>&pageNum=<%=pageNum%>&name=<%=bdto.getMember_id()%>" style=" color: inherit; text-decoration: none;"> <strong> <%= bdto.getSubject() %> </strong></a>
			    	...
			    	<div class="page_control">
			    		<%
			    			...
			    			if(count != 0) {
								...
								%>
								<p> <a href="Lockerboard_list.jsp?pageNum=<%= startPage - pageBlock %>"> <i class="fas fa-angle-left"></i>  </a> </p>
								<%
								}
								...
								<ol>
									<li>
										<a href="Lockerboard_list.jsp?pageNum=<%=i%>"><%= i %> </a>
									</li>
								</ol>
								<%
								}
								...
								if(endPage < pageCount) {
								%>
								<p> <a href="Lockerboard_list.jsp?pageNum=<%= startPage + pageBlock %>"> <i class="fas fa-angle-right"></i> </a> </p>
								<%
								}
			    			}
			    		%>
