							...
							<table class="main_table_collection">
					    		...
					    		<tbody>
						    		...
						    		<tr class="content_table_collection">
						    			...
						    			<td class="main_content"><a href="Relboard_content.jsp?board_type=<%=bdto.getBoard_type()%>&re_ref=<%=bdto.getRe_ref()%>&pageNum=<%=pageNum%>&name=<%=bdto.getMember_id()%>"> <%= bdto.getSubject() %> </a> </td>
						    			<td> <%= bdto.getMember_id() %> </td>
						    			<td> <%= bdto.getDate() %> </td>
						    			<td> <%= bdto.getReadcount() %> </td>
						    		</tr>
			    	...
			    	<div class="page_control">
			    		<%
			    			...
			    			if(count != 0) {
								...
								%>
								<p> <a href="Relboard_list.jsp?pageNum=<%= startPage - pageBlock %>"> <i class="fas fa-angle-left"></i>  </a> </p>
								<%
								}
								...
								<ol>
									<li>
										<a href="Relboard_list.jsp?pageNum=<%=i%>"><%= i %> </a>
									</li>
								</ol>
								<%
								}
								...
								if(endPage < pageCount) {
								%>
								<p> <a href="Relboard_list.jsp?pageNum=<%= startPage + pageBlock %>"> <i class="fas fa-angle-right"></i> </a> </p>
								<%
								}
			    			}
			    		%>
