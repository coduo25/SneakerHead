    		...
    		<div id="bb_contentWrap">
    			<div id="bb_content">
							...
							<table class="main_table_collection">
					    		...
					    		<tbody>
						    		...
						    		<tr class="content_table_collection">
						    			...
						    			<td class="main_content"><a href="Noticeboard_content.jsp?board_type=<%=bdto.getBoard_type()%>&re_ref=<%=bdto.getRe_ref()%>&pageNum=<%=pageNum%>&name=<%=bdto.getMember_id()%>" style="color: #ff4e59; font-weight: bold;"> <%= bdto.getSubject() %> </a> </td>
			    	...
			    	<div class="page_control">
			    		<%
			    			...
			    			if(count != 0) {
								...
								%>
								<p> <a href="Noticeboard_list.jsp?pageNum=<%= startPage - pageBlock %>"> <i class="fas fa-angle-left"></i>  </a> </p>
								<%
								}
								...
								<ol>
									<li>
										<a href="Noticeboard_list.jsp?pageNum=<%=i%>"><%= i %> </a>
									</li>
								</ol>
								<%
								}
								...
								if(endPage < pageCount) {
								%>
								<p> <a href="Noticeboard_list.jsp?pageNum=<%= startPage + pageBlock %>"> <i class="fas fa-angle-right"></i> </a> </p>
								<%
								}
			    			}
			    		%>
			    	...
			    	<div class="board_button">
			    		<!-- 글쓰기 버튼 란 -->
				    	<%
	    					//로그인이 되어있고 관리자이면 '글쓰기'버튼 나타나게 하기
	    					if(member_id != null) {
