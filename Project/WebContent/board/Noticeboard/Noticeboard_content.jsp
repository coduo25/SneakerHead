...
<body>
	...
	<%
    	...
    	String previous_board_type = request.getParameter("previous_board_type") == null ? "공지" : request.getParameter("previous_board_type");
    	
		//System.out.println("previous_board_type: " + previous_board_type);
						...
						<form action="#" method="post" name="fr" class="bbwrite_table" enctype="application/x-www-form-urlencoded">	
							...
							<div class="table_submit">
								...
								%>
									...
									<span class="gRight">
										<input class="gRight_List" type="button" value="목록" 
										<% if(previous_board_type.equals("발매")) { %> 
											onclick="location.href='/Project/board/Relboard/Relboard_list.jsp?pageNum=<%=pageNum%>';" 
										<% } else if(previous_board_type.equals("루머")) { %>
											onclick="location.href='/Project/board/Ruboard/Ruboard_list.jsp?pageNum=<%=pageNum%>';"
										<% } else if(previous_board_type.equals("공지")) {	%>
											onclick="location.href='Noticeboard_list.jsp?pageNum=<%=pageNum%>';"
										<% } %>
										>
								...
								%>
										<span class="gRight">
											<input class="gRight_List" type="button" value="목록" <% if(previous_board_type.equals("발매")) { %> 
											onclick="location.href='/Project/board/Relboard/Relboard_list.jsp?pageNum=<%=pageNum%>';" 
										<% } else if(previous_board_type.equals("루머")) { %>
											onclick="location.href='/Project/board/Ruboard/Ruboard_list.jsp?pageNum=<%=pageNum%>';"
										<% } else if(previous_board_type.equals("공지")) {	%>
