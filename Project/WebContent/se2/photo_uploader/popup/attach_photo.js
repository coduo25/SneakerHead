...
//    	sUploadURL= 'file_uploader_html5.php'; 	//upload URL
    	sUploadURL= '/Project/file_uploader_html5.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			//sURl 안에 정의된 페이지는 파일업로드를 처리하는 url이다. 
 			sUrl : '/Project/file_uploader.jsp',
 	        
 			//sCallback은 sURl에서 파일처리한 다음 파일정보를 return 해주는데 이 return 값들을 callback.html에서 처리해주는 역할을 한다. 
 			sCallback : '/Project/se2/photo_uploader/popup/callback.html',
