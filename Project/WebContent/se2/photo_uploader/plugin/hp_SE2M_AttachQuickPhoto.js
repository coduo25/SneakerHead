...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		...
		this.htPopupOption.sProperties = "left=400,top=150,width=403,height=359,scrollbars=no,location=no,status=0,resizable=no";
	...
	_getPhotoTag : function(htPhotoInfo){
		...
		var sTag = '<p style="text-align: center;"> <img src="{=sOriginalImageURL}" title="{=sName}" style="width:85%;"> </p>'; //sTag는 업로드팝업창에서 확인을 눌렸을때 글쓰기 영역에 들어갈때 나타나는 style 
